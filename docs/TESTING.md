...
| R2 | 2026-09-09 | agent | ✓ steps 2-4: bubble present on bills, form and reports; fourth card reads exactly "Worth disputing"; the logo returns to the list from every screen and "New audit" reaches the form. Every fresh load of /app landed on **Bills & coverage**, never the audit form. Step 1's sign-out/sign-in leg still needs a password |
