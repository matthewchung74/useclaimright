...
| E5 | 2026-09-09 | agent | ✓ plan restored (Acme Silver PPO, 2026-01-01 → 2026-12-31), trackers **re-derived with no duplicates** — exactly two, keeping their contributing-audit counts (1 and 5). "Individual target from your plan (SBC)" returned to the deductible card and the out-of-pocket card came back with it |
