...
| P1 | 2026-09-09 | agent | `cms-2025.pdf` (earlier) and **`cms-2019.pdf`** ✓ — the latter extracted $500 individual / $2,500 OOP plus Home health 60/yr, Rehabilitation 60/yr and Children's glasses 1/yr, and is the SBC FAM2 now runs against. `cms-older.pdf`, `dol-sample-2` and `dol-sample-3` still not run |
