...
**Interfaces:**
- Produces: `test-fixtures/fake-sbc.html` — Acme Silver PPO SBC. Planted values (consumed by Task 11 verification): deductible $1,500/$3,000 family, OOP max $6,000/$12,000, coverage period 2026-01-01→2026-12-31, limit row "Outpatient mental health services: $0 coinsurance after deductible — limited to 6 visits per plan year", planted mismatch hook "Rehabilitation services (physical, occupational therapy) — $60 copay/visit, deductible does not apply" (contradicts the p1 fixture pair, which applies $120 to the deductible → expected copay_mismatch/deductible_misapplied, ~$60 delta). NOTE: this corrects the spec's illustrative "$115 specialist" example — the planted hook must contradict a fixture bill that actually exists, and p1 (97110 PT, $120, 2026-03-20, in-period) is that bill.
